...
public class Player {
    ...
    private int           jump          = 0, jumpSpeed = 20, fallSpeed = 20,
            dimension = 64, waitTime = 0;
    ...
    private boolean       jumping       = false, falling = true,
            checkBoth = false;
    private Sound         jumpSound     = Gdx.audio
            .newSound(Gdx.files.internal("jump.wav"));
    private TextureRegion jumpTexture;                                        // Make
                                                                              // texture
                                                                              // region
    ...
    private String        decompiler    = "......";                           // Release
                                                                              // change
                                                                              // this
    ...
    public Player(TextureRegion jumpTexture, TextureRegion neutralTexture,
    ...
    public void update() {
        ...
        if ((Gdx.input.isTouched() || playMenu == true) && jumping == false
                && waitTime == 0) {
            jumpSound.play();
            jumping = true;
        }
        ...
        if (jumping == true) {
            ...
            y = y - jumpSpeed > Constants.BASE_HEIGHT ? y - jumpSpeed
